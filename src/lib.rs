...
//! for types used in the AXIA Axlib framework.
//!
...
//! take a look at the
//! [SCALE Code page at the Axlib Knowledge Base](https://axlib.dev/docs/en/knowledgebase/advanced/codec).
//!
//! ## Implementation
//!
...
//! them even more space/memory efficient. The compact encoding is described [here](https://axlib.dev/docs/en/knowledgebase/advanced/codec#compactgeneral-integers).
//!
