...
///
/// ```
///# use axia_scale_codec::{EncodeLike, Encode};
...
/// ```
///# use axia_scale_codec::{EncodeLike, Encode, WrapperTypeEncode};
/// fn encode_like<T: Encode, R: EncodeLike<T>>(data: &R) {
///     data.encode(); // Valid `T` encoded value.
/// }
///
...
/// }
///
/// impl<'a> axia_scale_codec::WrapperTypeEncode for MyWrapper<'a> {}
/// impl<'a> axia_scale_codec::EncodeLike<(u32, u32)> for MyWrapper<'a> {}
///
/// fn main() {
...
///
/// ```rust
/// # use axia_scale_codec::{EncodeLike, Ref};
