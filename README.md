...
take a look at the
[low-level data formats overview page at the Axlib docs site](https://axlib.dev/docs/en/knowledgebase/advanced/codec).
...
The compact encoding is described [here](https://axlib.dev/docs/en/knowledgebase/advanced/codec#compactgeneral-integers).
